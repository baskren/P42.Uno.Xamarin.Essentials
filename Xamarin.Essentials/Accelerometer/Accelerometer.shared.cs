...
public static partial class Accelerometer
{
    ...
    static readonly AccelerometerQueue queue = new();
...
public readonly struct AccelerometerData : IEquatable<AccelerometerData>
{
    ...
    public override string ToString() =>
        $"{nameof(Acceleration.X)}: {Acceleration.X}, {nameof(Acceleration.Y)}: {Acceleration.Y}, {nameof(Acceleration.Z)}: {Acceleration.Z}";
}