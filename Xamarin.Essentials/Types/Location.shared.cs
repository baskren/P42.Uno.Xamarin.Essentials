...
public class Location
{
    ...
    public override string ToString() =>
        $"{nameof(Latitude)}: {Latitude}, {nameof(Longitude)}: {Longitude}, {nameof(Altitude)}: {Altitude}, {nameof(Accuracy)}: {Accuracy}, {nameof(VerticalAccuracy)}: {VerticalAccuracy}, {nameof(Speed)}: {Speed}, {nameof(Course)}: {Course}, {nameof(Timestamp)}: {Timestamp}";
}