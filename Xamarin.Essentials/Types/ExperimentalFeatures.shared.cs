...
public static class ExperimentalFeatures
{
        ...
        [CallerMemberName] string memberName = "")
    {
        if (enabledFeatures == null || !enabledFeatures.Contains(featureName))
        {
            ...
            var errorMessage =
                $"The class, property, or method you are attempting to use {call}an experimental feature; to use it, you must opt-in by calling ExperimentalFeatures.Enable(\"{featureName}\") before using this feature.";
