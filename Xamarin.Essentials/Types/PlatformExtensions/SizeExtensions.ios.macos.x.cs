...
public static partial class SizeExtensions
{
    ...
    public static SizeF ToSystemSizeF(this iOSSize size) => new((float)size.Width, (float)size.Height);

    public static iOSSize ToPlatformSize(this Size size) => new((nfloat)size.Width, (nfloat)size.Height);

    public static iOSSize ToPlatformSize(this SizeF size) => new((nfloat)size.Width, (nfloat)size.Height);
}