...
public static partial class FileSystem
{
    ...
    internal static class Extensions
    {
        ...
        internal static string[] AllVideo =>
            [Mp4, Mov, Avi, Wmv, M4v, Mpg, Mpeg, Mp2, Mkv, Flv, Gifv, Qt];
...
public partial class ReadOnlyFile : FileBase
{
    ...
    public static explicit operator ReadOnlyFile(StorageFile storageFile)
        => new(storageFile);
}
...
public partial class FileResult : FileBase
{
    ...
    public static explicit operator FileResult(StorageFile storageFile)
        => new(storageFile);
}