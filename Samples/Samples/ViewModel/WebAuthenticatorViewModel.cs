...
public class WebAuthenticatorViewModel : BaseViewModel
{
    ...
    {
        MicrosoftCommand = new Xamarin.Essentials.Command(async () => await OnAuthenticate("Microsoft"));
        GoogleCommand = new Xamarin.Essentials.Command(async () => await OnAuthenticate("Google"));
        FacebookCommand = new Xamarin.Essentials.Command(async () => await OnAuthenticate("Facebook"));
        AppleCommand = new Xamarin.Essentials.Command(async () => await OnAuthenticate("Apple"));
    }
