...
public class MediaPickerViewModel : BaseViewModel
{
    ...
    {
        PickPhotoCommand = new Xamarin.Essentials.Command(DoPickPhoto);
        CapturePhotoCommand = new Xamarin.Essentials.Command(DoCapturePhoto, () => MediaPicker.IsCaptureSupported);

        PickVideoCommand = new Xamarin.Essentials.Command(DoPickVideo);
        CaptureVideoCommand = new Xamarin.Essentials.Command(DoCaptureVideo, () => MediaPicker.IsCaptureSupported);
    }
