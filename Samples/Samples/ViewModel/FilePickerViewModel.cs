...
public class FilePickerViewModel : BaseViewModel
{
    ...
    {
        PickFileCommand = new Xamarin.Essentials.Command(() => DoPickFile());
        PickImageCommand = new Xamarin.Essentials.Command(() => DoPickImage());
        PickPdfCommand = new Xamarin.Essentials.Command(() => DoPickPdf());
        PickCustomTypeCommand = new Xamarin.Essentials.Command(() => DoPickCustomType());
        PickAndSendCommand = new Xamarin.Essentials.Command(() => DoPickAndSend());
        PickMultipleFilesCommand = new Xamarin.Essentials.Command(() => DoPickMultipleFiles());
    }
    ...
    async void DoPickCustomType()
    {
        var customFileType =
            ...
            {
                { DevicePlatform.iOS, ["public.my.comic.extension"] }, // or general UTType values
                { DevicePlatform.Android, ["application/comics"] },
                { DevicePlatform.Windows, [".cbr", ".cbz"] },
                { DevicePlatform.Tizen, ["*/*"] },
                { DevicePlatform.MacOS, ["cbr", "cbz" ] }, // or general UTType values
                { DevicePlatform.WASM, [".exe", ".dll"] }
            });
