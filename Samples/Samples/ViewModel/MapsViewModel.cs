...
public class MapsViewModel : BaseViewModel
{
    ...
    public string[] NavigationModes { get; } =
       Enum.GetNames(typeof(Xamarin.Essentials.NavigationMode));
    ...
    {
        MapsCommand = new Xamarin.Essentials.Command(OpenLocation);
        LaunchPlacemarkCommand = new Xamarin.Essentials.Command(OpenPlacemark);
    }
    ...
    async void OpenLocation()
    {
        ...
        {
            Name = Name,
            NavigationMode = (Xamarin.Essentials.NavigationMode)NavigationMode
        });
    }
