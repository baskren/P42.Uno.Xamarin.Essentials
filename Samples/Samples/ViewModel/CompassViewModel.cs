...
class CompassViewModel : BaseViewModel
{
    ...
    {
        StartCompass1Command = new Xamarin.Essentials.Command(OnStartCompass1);
        StopCompass1Command = new Xamarin.Essentials.Command(OnStopCompass1);
        StartCompass2Command = new Xamarin.Essentials.Command(OnStartCompass2);
        StopCompass2Command = new Xamarin.Essentials.Command(OnStopCompass2);
    }
