...
class ClipboardViewModel : BaseViewModel
{
    ...
    {
        CopyCommand = new Xamarin.Essentials.Command(OnCopy);
        PasteCommand = new Xamarin.Essentials.Command(OnPaste);
        CheckCommand = new Xamarin.Essentials.Command(OnCheck);
    }
