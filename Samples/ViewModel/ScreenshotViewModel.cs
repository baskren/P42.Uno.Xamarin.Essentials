...
class ScreenshotViewModel : BaseViewModel
{
    ...
    {
        ScreenshotCommand = new Xamarin.Essentials.Command(async () => await CaptureScreenshot(), () => Screenshot.IsCaptureSupported);
        EmailCommand = new Xamarin.Essentials.Command(async () => await EmailScreenshot(), () => Screenshot.IsCaptureSupported);
    }
